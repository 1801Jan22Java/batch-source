...
ALTER TABLE REIMBURSEMENT_REQUEST 
ADD CONSTRAINT FK_REC_ID 
FOREIGN KEY (RECEIPT_ID) REFERENCES RECEIPTS(REC_ID);
...
CREATE SEQUENCE SQ_RECEIPTS_PK
START WITH 1001
INCREMENT BY 1;
/
...
CREATE OR REPLACE TRIGGER TR_INSERT_RECEIPTS
BEFORE INSERT ON RECEIPTS
FOR EACH ROW
BEGIN
  SELECT SQ_RECEIPTS_PK.NEXTVAL INTO :NEW.RECEIPT_ID FROM DUAL;
END;
/
