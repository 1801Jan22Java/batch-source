...
public class User implements Serializable{
	...
	private Location location; //fk to locID of table locations
	...
	public User(String email, String password, String firstname, String lastname, int phonenumber,
			Location location, LookupTable isEmployee) {
		super();
		this.email = email;
	...
	public User(int userID, String email, String password, String firstname, String lastname, int phonenumber,
			Location location, LookupTable isEmployee) {
		super();
		this.userID = userID;
		this.email = email;
