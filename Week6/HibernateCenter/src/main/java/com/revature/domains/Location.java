...
public class Location implements Serializable{
	...
	public Location(String street, String city, String state, int zipcode, List<Animal> animals) {
		super();
		this.street = street;
		this.city = city;
		this.state = state;
	...
	public Location(int locID, String street, String city, String state, int zipcode, List<Animal> animals) {
		super();
		this.locID = locID;
		this.street = street;
		this.city = city;
