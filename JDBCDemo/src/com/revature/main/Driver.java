...
public class Driver {
	...
	public static void main(String[] args) {
		...
		/* Connection con = null;
		 ...
		 try { con = ConnectionUtil.getConnectionFromFile("connection.properties");
		...
		// Bear joe = new Bear("Joe",new Cave(7,"Reston",10),new
		// BearType(5,"Grizzly"),200, LocalDate.of(1992, 9, 5));
