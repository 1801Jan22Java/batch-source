...
ALTER TABLE ACCOUNT_TRANSACTION ADD AMOUNT_CHANGED FLOAT;
COMMIT;
/
...
INSERT INTO ACCOUNT_TRANSACTION 
    (Transaction_ID,USER_ID,ACCOUNT_ID,DATE_OF_TRANSACTION,TRANSACTION_DESC,AMOUNT_CHANGED)
    SELECT account_tx_seq.nextval,USER_ID,ACCOUNT_ID, CURRENT_TIMESTAMP, 'Deposit made',AMOUNT
...
INSERT INTO ACCOUNT_TRANSACTION 
    (Transaction_ID,USER_ID,ACCOUNT_ID,DATE_OF_TRANSACTION,TRANSACTION_DESC,AMOUNT_CHANGED)
    SELECT account_tx_seq.nextval,USER_ID,ACCOUNT_ID, CURRENT_TIMESTAMP, 'Withdrawal made',AMOUNT
    FROM ACCOUNTS WHERE ACCOUNT_ID = ACCOUNTID AND USER_ID = USER_ID;
COMMIT;
END;
/
...
AS BEGIN 
DELETE FROM ACCOUNT_TRANSACTION WHERE ACCOUNT_ID = ACC_ID;
