	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-10">
				...
				<br>
				<form action="/ReimbursementApp/updateMemberInfo.do" method="post" id="updateForm">
					...
					<table class="table table-hover table-bordered text-center">
						...
						<tbody>
							...
							<tr>
								<td>Password</td>
								<td>
									<input id="password" name= "password" style="text-align: center;" type="text" value="<c:out value="${mVo.pwd }"/>">
								</td>
							</tr>
							<tr>
								<td>Email</td>
								<td>
									<input id="email" name="email" style="text-align: center;" type="text" value="<c:out value="${mVo.email }"/>">
								</td>
							</tr>
							<tr>
								<td>Level</td>
				...
				<div class="row btn-toolbar">
					<button id="moveToReqList" class="btn btn-success navbar-btn pull-right ">Go Back to Request List</button>
					<button id="modify" class="btn btn-success navbar-btn pull-right ">Submit</button>
				</div>
...
<script>
	window.onload = function() {
		...
		document.getElementById("modify").addEventListener("click", updateMemberInfo);
	...
	function updateMemberInfo(event) {
		...
		if (window.confirm("Are you sure to modify user Information?")){
