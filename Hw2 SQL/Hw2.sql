...
-- 3 SQL FUNCTIONS
--3.1 PART A
--________FIGURE OUT HOW TO PARSE OUT DATE
...
--3.2 PART B
-- ______NEED TO MAKE INTO A FUNCTION
SET SERVEROUTPUT ON;
...
--4.2 PART A
--______DOES NOT WORK 
CREATE OR REPLACE PROCEDURE UPDATE_PERSONAL_INFO(ID_NUM NUMBER,L_NAME VARCHAR2)
AS
BEGIN
UPDATE EMPLOYEE 
SET LASTNAME = L_NAME
...
END;
/
EXECUTE UPDATE_PERSONAL_INFO(2,'DFDFDS');
-- 4.2 PART B
SET SERVEROUTPUT ON;
DECLARE 
HOLDER VARCHAR2 (200);
...
--5.0
--______________________PUT COMMITS IN
--COMMIT;
SAVEPOINT;
SET SERVEROUTPUT ON;
