...
public abstract class Question18Superclass {
	...
	public abstract boolean checkForUppercase(String string);
	public abstract String lowercaseToUppercase(String string);
	public abstract int convertAndAdd(String string);
