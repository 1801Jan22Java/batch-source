...
DROP TABLE BEAR cascade constraints;
DROP TABLE BEAR_TYPE cascade constraints;
DROP TABLE CAVE cascade constraints;
DROP TABLE BEEHIVE cascade constraints;
DROP TABLE BEAR_BEEHIVE cascade constraints;
/
CREATE TABLE BEAR (
