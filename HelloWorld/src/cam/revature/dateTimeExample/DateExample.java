package cam.revature.dateTimeExample;
...
public class DateExample {
	...
	public static void main(String[] args) {
		...
		System.out.println("Europe/Moscow" + ZonedDateTime.now(ZoneId.of("Europe/Moscow")));
		...
		System.out.println("Months until staging: " + Period.between(ldt1,ldt2).getMonths());
		System.out.println("Days until staging: " + ChronoUnit.DAYS.between(ldt1, ldt2));
		LocalDateTime ldt3= LocalDateTime.now();
		LocalDateTime ldt4 = LocalDateTime.now().plusWeeks(9);
		System.out.println("Minutes until staging: " + ChronoUnit.MINUTES.between(ldt3, ldt4));
