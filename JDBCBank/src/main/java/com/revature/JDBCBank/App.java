...
public class App {
	public static void main(String[] args) {
		...
		try {
			...
			loop: while (true) {
				System.out.println(
						"Options for user: (1)view accounts, (2)create account, (3)delete account, (4)deposit account, (5)withdraw account, (6)logout");
				if (user.getUserID() == 1) {
					System.out.println(
							"Options for superUser: (7)view users, (8)create user, (9)update user, (10)delete user");
				}
				...
				switch (option) {
				case 1:
					dao.viewAccounts(user);
					break;
				case 2:
					System.out.print("Please enter balance for new account: ");
					dao.newAccount(user, sc.nextDouble());
					sc.nextLine();
					break;
				case 3:
					System.out.print("Please enter AccountID to be dropped: ");
					dao.deleteAccount(user, sc.nextInt());
					sc.nextLine();
					break;
				case 4:
					System.out.print("Please enter AccountID to deposit into: ");
					...
					break;
				case 5:
					System.out.print("Please enter AccountID to withdraw from: ");
